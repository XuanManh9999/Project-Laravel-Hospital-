...
@section('title', 'Trang chủ - Hệ thống Quản lý Bệnh viện')
        ...
        <div class="row align-items-center py-5">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    @auth
                        @if(auth()->user()->isPatient())
                            <a href="{{ route('patient.doctors.index') }}" class="btn btn-light btn-lg">
                                <i class="bi bi-calendar-plus"></i> Đặt lịch hẹn
                            </a>
                            <a href="{{ route('patient.profile') }}" class="btn btn-outline-light btn-lg">
                                <i class="bi bi-person"></i> Thông tin cá nhân
                            </a>
                        @elseif(auth()->user()->isDoctor())
                            <a href="{{ route('doctor.appointments.index') }}" class="btn btn-light btn-lg">
                                <i class="bi bi-calendar-check"></i> Lịch hẹn của tôi
                            </a>
                            <a href="{{ route('doctor.profile') }}" class="btn btn-outline-light btn-lg">
                                <i class="bi bi-person"></i> Thông tin cá nhân
                            </a>
                        @elseif(auth()->user()->isReceptionist())
                            <a href="{{ route('receptionist.appointments.index') }}" class="btn btn-light btn-lg">
                                <i class="bi bi-calendar-check"></i> Lịch hẹn phòng khám
                            </a>
                            <a href="{{ route('receptionist.profile') }}" class="btn btn-outline-light btn-lg">
                                <i class="bi bi-person"></i> Thông tin cá nhân
                            </a>
            ...
            <div class="col-lg-6 text-center">
                @if(file_exists(public_path('images/logo.png')))
                    <img src="{{ asset('images/logo.png') }}" alt="Hospital Logo" class="img-fluid" style="max-height: 400px; filter: drop-shadow(0 10px 30px rgba(255,255,255,0.3));">
                @elseif(file_exists(public_path('images/logo.jpg')))
                    <img src="{{ asset('images/logo.jpg') }}" alt="Hospital Logo" class="img-fluid" style="max-height: 400px; filter: drop-shadow(0 10px 30px rgba(255,255,255,0.3));">
                @else
...
<div class="container">
    ...
    <section id="doctors" class="mb-5 py-5">
        <div class="text-center mb-4">
            ...
            <a href="{{ route('public.doctors.index') }}" class="btn btn-outline-primary">
            ...
            <div class="row g-4 text-white text-center">
                <div class="col-md-3">
                    <div class="p-4">
                        ...
                        <h3 class="display-4 fw-bold">{{ \App\Models\Doctor::count() }}</h3>
                ...
                <div class="col-md-3">
                    <div class="p-4">
                        ...
                        <h3 class="display-4 fw-bold">{{ \App\Models\Patient::count() }}</h3>
                ...
                <div class="col-md-3">
                    <div class="p-4">
                        ...
                        <h3 class="display-4 fw-bold">{{ \App\Models\Service::where('status', 'active')->count() }}</h3>
                ...
                <div class="col-md-3">
                    <div class="p-4">
                        ...
                        <h3 class="display-4 fw-bold">{{ \App\Models\Appointment::where('status', 'accepted')->count() }}</h3>
    ...
    <section id="news" class="mb-5 py-5">
        <div class="text-center mb-5">
            ...
            <a href="{{ route('posts.index') }}" class="btn btn-outline-primary mt-2">
