        ...
        <div class="col-md-3 mb-4">
            ...
            <div class="card border-0 shadow-sm mt-3">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('patient.profile') }}#change-password" class="list-group-item list-group-item-action">
                        <i class="bi bi-key me-2"></i> Đổi mật khẩu
                    </a>
                    <a href="{{ route('patient.history') }}" class="list-group-item list-group-item-action active">
