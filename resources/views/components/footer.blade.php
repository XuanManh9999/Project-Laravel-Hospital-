        ...
        <div class="row g-4">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        @if(file_exists(public_path('images/logo.png')))
                            <img src="{{ asset('images/logo.png') }}" alt="Logo" class="me-2" style="height: 40px; width: auto; filter: brightness(0) invert(1);">
                        @elseif(file_exists(public_path('images/logo.jpg')))
                            <img src="{{ asset('images/logo.jpg') }}" alt="Logo" class="me-2" style="height: 40px; width: auto; filter: brightness(0) invert(1);">
                        @else
            ...
            <div class="col-lg-2 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('welcome') }}#services" class="text-white text-decoration-none">
                            <i class="bi bi-briefcase me-1"></i> Dịch vụ
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('welcome') }}#doctors" class="text-white text-decoration-none">
                            <i class="bi bi-person-badge me-1"></i> Bác sĩ
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('welcome') }}#news" class="text-white text-decoration-none">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <p class="text-white mb-0">
                    &copy; {{ date('Y') }} Hospital Management. Tất cả quyền được bảo lưu.
                </p>
            </div>
