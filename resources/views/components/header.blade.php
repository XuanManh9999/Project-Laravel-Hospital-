        ...
        <div class="container">
            <a class="navbar-brand fw-bold text-primary d-flex align-items-center" href="{{ route('welcome') }}">
                ...
                @elseif(file_exists(public_path('images/logo.jpg')))
                    <img src="{{ asset('images/logo.jpg') }}" alt="Logo" class="me-2" style="height: 40px; width: auto;">
                @else
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('welcome') }}#doctors">
                        ...
                        <li class="nav-item dropdown" style="position: relative;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="navbarDropdown" style="z-index: 1051; min-width: 250px;">
                                ...
                                @else
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route(auth()->user()->role . '.profile') }}#change-password">
                                ...
                                @if(auth()->user()->isPatient())
                                    <li>
                                        <a class="dropdown-item" href="{{ route('patient.history') }}">
                                            <i class="bi bi-calendar-check me-2"></i> Lịch khám của tôi
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('patient.doctors.index') }}">
                                            <i class="bi bi-person-badge me-2"></i> Đặt lịch hẹn
                                        </a>
                                    </li>
                                @elseif(auth()->user()->isDoctor())
                                    <li>
                                        <a class="dropdown-item" href="{{ route('doctor.appointments.index') }}">
                                            <i class="bi bi-calendar-check me-2"></i> Lịch hẹn của tôi
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('doctor.history') }}">
                                            <i class="bi bi-clock-history me-2"></i> Lịch sử
                                        </a>
                                    </li>
                                @elseif(auth()->user()->isReceptionist())
                                    <li>
                                        <a class="dropdown-item" href="{{ route('receptionist.appointments.index') }}">
