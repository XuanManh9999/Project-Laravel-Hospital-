...
unset($__errorArgs, $__bag); ?>" 
                           name="price" value="<?php echo e(old('price')); ?>" min="0" step="1000" required>
...
unset($__errorArgs, $__bag); ?>" 
                           name="duration" value="<?php echo e(old('duration')); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="status" class="form-select" required>
                        ...
                        <option value="inactive" <?php echo e(old('status') == 'inactive' ? 'selected' : ''); ?>>Tạm dừng</option>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\workspace\DACN\WEBSITE_BENH_VIEN\resources\views/admin/services/create.blade.php ENDPATH**/ ?>