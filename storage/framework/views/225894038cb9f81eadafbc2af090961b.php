...
<?php $__env->startSection('title', 'Lịch hẹn phòng khám'); ?>
        ...
        <div class="col-md-3 mb-4">
            ...
            <div class="card border-0 shadow-sm mt-3">
                <div class="list-group list-group-flush">
                    <a href="<?php echo e(route('receptionist.profile')); ?>" class="list-group-item list-group-item-action">
                        <i class="bi bi-person me-2"></i> Thông tin cá nhân
                    </a>
                    <a href="<?php echo e(route('receptionist.profile')); ?>#change-password" class="list-group-item list-group-item-action">
                        <i class="bi bi-key me-2"></i> Đổi mật khẩu
                    </a>
                    <a href="<?php echo e(route('receptionist.appointments.index')); ?>" class="list-group-item list-group-item-action active">
