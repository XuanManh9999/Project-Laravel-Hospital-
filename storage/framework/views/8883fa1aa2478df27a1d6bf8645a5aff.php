<?php if($paginator->hasPages()): ?>
    <nav class="d-flex justify-content-center align-items-center flex-wrap gap-3">
        ...
        <div class="d-none d-sm-flex flex-sm-fill align-items-sm-center justify-content-sm-between w-100">
            <div>
...
<?php endif; ?>
<?php /**PATH D:\workspace\DACN\WEBSITE_BENH_VIEN\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>