...
<div class="card">
    <div class="card-body">
        <div class="d-flex gap-2 flex-wrap">
            <?php if(in_array($appointment->status, ['pending','accepted','waiting_examination'])): ?>
        ...
        <?php if(in_array($appointment->status, ['pending','accepted','waiting_examination']) && $appointment->payment_status === 'paid'): ?>
            <div class="alert alert-info mt-3 mb-0">
                <small>
