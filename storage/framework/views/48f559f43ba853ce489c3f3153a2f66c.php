        ...
        <div class="col-md-3 mb-4">
            ...
            <div class="card border-0 shadow-sm mt-3">
                <div class="list-group list-group-flush">
                    ...
                    <a href="<?php echo e(route('receptionist.appointments.index')); ?>" class="list-group-item list-group-item-action">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="profile-info">
                            <form method="POST" action="<?php echo e(route('receptionist.profile.update')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="shift" value="<?php echo e($receptionist->shift); ?>" placeholder="VD: Sáng (8h-12h)">
                                </div>
                        ...
                        <div class="tab-pane fade" id="change-password">
                            <form method="POST" action="<?php echo e(route('receptionist.profile.change-password')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\workspace\DACN\WEBSITE_BENH_VIEN\resources\views/receptionist/profile.blade.php ENDPATH**/ ?>